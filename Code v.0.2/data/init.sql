...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 28, 2022 at 03:23 PM
...
('root', '[{\"db\":\"service_page\",\"table\":\"service_page\"},{\"db\":\"service\",\"table\":\"service\"},{\"db\":\"review\",\"table\":\"review\"},{\"db\":\"product_page\",\"table\":\"product_page\"},{\"db\":\"product\",\"table\":\"product\"},{\"db\":\"uph\",\"table\":\"tableuph\"}]');
...
('root', '2022-11-28 14:21:15', '{\"Console\\/Mode\":\"collapse\"}');
...
CREATE TABLE `product_page` (
  ...
  `star_rating_produk` tinyint(5) NOT NULL,
...
CREATE TABLE `service_page` (
  ...
  `star_rating_service` tinyint(5) NOT NULL,
  `deskripsi_service` text NOT NULL,
  `gambar_service` blob NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
